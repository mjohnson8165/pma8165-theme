...
// TODO: Add more top padding to the .group boxes in the Settings section
// TODO: Style the navbar in the Settings section (#topmenu2) similar to the main one above it
// TODO: Exorcize the tabbed view from the rest of the subsections of the Settings section
// FIXME: Fix the vertical alignment and padding of the elements in the lower table from the Binary Log section
// TODO: Remove HR elements and fix vertical alignment of table elements in the Slave Replication section
// FIXME: Fix top row styling and hovering effect on all rows in the Variables table
// FIXME: Higlight charset descriptions above each table in the Charsets section
// FIXME: Fix the hovering effect on the rows of the storage engine table in the Engines section
